...
compile:
	GO111MODULE=on GOGC=off CGOENABLED=0 go build -ldflags "-s -X github.com/packethost/docker-machine-driver-packet/pkg/drivers/packet" -o bin/$(current_dir)$(BIN_SUFFIX)/$(current_dir) ./bin/...
